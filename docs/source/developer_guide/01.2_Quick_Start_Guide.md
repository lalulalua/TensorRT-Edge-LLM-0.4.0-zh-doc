...
**Input Format:** Our format matches closely with the OpenAI API format. Please see `examples/llm/INPUT_FORMAT_en.md` for more details. Some example input files are available in `tests/test_cases/` (for example, `llm_basic.json`).
